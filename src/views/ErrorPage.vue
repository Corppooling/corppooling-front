...
<template>
  ...
  >
    <span
      class="absolute left-0 top-0 z-0 flex h-full w-full select-none items-center justify-center text-[10rem] font-bold text-content-flight drop-shadow-neon-light sm:text-[20rem] lg:text-[30rem] xl:text-[40rem]"
    >
      {{ codeError }}
    </span>
